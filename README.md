...
5. Visualization and SNP Annotation: Utilized R and the `qqman` package to generate [Manhattan Plots](https://github.com/MohakKarkhanis/Project-05/blob/main/Plots/Manhattan_AWPR_REPRO.png), visualizing the statistical significance (-log(P)) of each SNP across all 12 chromosomes. Filtered the results against a strict genome-wide significance threshold (P < 5e-8) to isolate.
