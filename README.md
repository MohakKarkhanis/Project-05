...
Some of the Quality Control Data can be seen in the folder [Quality Control]()
4. Capturing Genetic Variation: Performed PCA on the remaining 3001 samples to capture the genetic variations. The resulting eigenvectors (PC1 to PC5) were extracted using Python to serve as covariates in the final Mixed Linear model.
5. 
